...
time_arr, traj_list = load_runs(n_particles, t_sim, t_eq, dt, v0, Dt, Dr, n_runs, walls, pairwise, eta)
...
ax.plot(time_arr, MSD_diffusive, linestyle="--", label=r"long term: MSD(t)$\approx 4 \, D_\text{eff} \, t$")
ax.plot(time_arr, MSD_ballistic, color="green", linestyle="dotted", label=r"ballistic term: MSD(t)$\approx v_0^2 \, t^2$")
ax.plot(time_arr, MSD_simple_theory, color="red", linestyle="dotted", label=r"short term: MSD(t)$\approx 4 \, D_\text{t} \, t$")
ax.set_xlabel(r"$t$ [$\tau_\text{BD}$]")
ax.set_ylabel(r"$MSD(t)$")
